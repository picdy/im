    ...
    'History': {
        ...
        'Init':function(){
            ...
            if(jsondata.length > 0){
                for($i=0; $i<jsondata.length; $i++){
                    html +='<li class="list-item"><a href="'+jsondata[$i].link+'" class="list-item-link">'+jsondata[$i].name+'</a></li>';
                }
            }else{
                html +='<li class="list-item"><a>暂无浏览记录</a></li>';
            }
        ...
        'Set':function(name,link,list){
            ...
            if(jsondata != undefined){
                ...
                jsonstr = '{log:[{"name":"'+name+'","link":"'+link+'","list":"'+list+'"},';
                for($i=0; $i<this.Json.length; $i++){
                    if($i<= this.Limit && this.Json[$i]){
                        jsonstr += '{"name":"'+this.Json[$i].name+'","link":"'+this.Json[$i].link+'","list":"'+this.Json[$i].list+'"},';
                    }else{
                        break;
                    }
                }
